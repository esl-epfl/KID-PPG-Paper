...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 29 13:10:36 2023
...
for test_subject_id in range(1, 16):
    ...
    model.load_weights('./saved_models/adaptive_w_temp_attention_high_hr/model_weights/model_S' + str(int(test_subject_id)) + '.h5')
    ...
    output_path = './results/model_predictions/adaptive_w_temp_attention_high_hr/'
