...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 28 18:37:06 2023
...
for split in splits:
    ...
    for validate_indexes, test_indexes in logo.split(X_val_test, y_val_test, groups[test_val_indexes]):
        ...
        # save model weights
        checkpoint = ModelCheckpoint('./saved_models/adaptive_w_temp_attention_high_hr/model_weights/model_S' + str(test_subject_id) + '.h5', 
